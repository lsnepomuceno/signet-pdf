...
use LSNepomuceno\Signet\Validation\RevocationChecker;
...
it('pulls the material out of a document security store', function () {
    ...
    $material = resolve(LSNepomuceno\Signet\Validation\RevocationReader::class)->material($pdf);
...
it('finds nothing in a document that carries no store', function () {
    $material = resolve(LSNepomuceno\Signet\Validation\RevocationReader::class)
...
it('reports unknown for a document whose store carries no revocation material', function () {
    ...
    $report = resolve(LSNepomuceno\Signet\Contracts\SignatureValidator::class)
